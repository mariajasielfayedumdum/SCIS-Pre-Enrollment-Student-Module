            ...
            <div class="white-box" style="position: absolute; width: 37%; height: 350px; top: 20%; right: 1%;">
                ...
                @foreach($subject as $query)
                    ...
                    <form method="post" action="#">
                        ...
                        {{csrf_field()}}
                        <input class='btn btn-primary btn-sm' value="Submit" style="margin-left: 40%; margin-top:5%; width:15%; height: 20%; padding: 8px 10px 8px 10px; font-size: 120%;" type="submit">
                    </form>
                    @endforeach
            </div>
