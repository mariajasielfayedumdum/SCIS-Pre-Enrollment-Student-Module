                    ...
                    <div style="width: 100%;">
                        <center>
                            ...
                            @elseif(!isset($details))
                                <div class="white-box" style="width: 90%; height: 650px;">
                                    <div class="table-responsive" style="overflow-y:scroll; height: 560px; width: 100%; margin-top: -.6%;">
                                        <table class="table" style="position: absolute; display: block; z-index: 100; background-color:white;width:73.7%;">
                                            <tr>
                                                <th style="width:15%;" >Course Number</th>
                                                <th style="width:25%;" >Descriptive Title</th>
                                                <th style="width:15%;" >Units</th>
                ...
                <div style="width: 100%;">
                    <center>
                        @if(isset($details))
                            <div class="white-box" style="width: 90%; height: 650px;">
                                <div class="table-responsive" style="overflow-y:scroll; height: 560px; width: 100%; margin-top: -.6%;">
                                    <table class="table" id="copy" style="width:100%;">
                                        <th style="width:15%;" >Course Number</th>
                                        <th style="width:25%;" >Descriptive Title</th>
                                        <th style="width:15%;" >Units</th>
                                        <th style="width:15%;" >Term</th>
                                ...
                                <div class="table-responsive" style="overflow-y:scroll; height: 560px; width: 100%; margin-top: -.6%;">
                                    <table class="table" style="position: absolute; display: block; z-index: 100; background-color:white;width:73.7%;">
                                        <tr>
                                            ...
                                            <th>Course Number</th><th></th><th></th><th></th><th></th>
                                            ...
                                            <th>Number of Students</th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th>
                                        </tr>
                                    </table>
                                    <br><br><br>
                                    <table class="table" id="copy">
